...
CAUTION! this example requires a moderate amount of computing resources (especially RAM!) which I have already made a request for (24 Jan 2020). Until we have more computing resources to run this example I suggest you to clone this [repository](https://github.com/dymium-org/dymiumExampleProject) and run it on your machine.
